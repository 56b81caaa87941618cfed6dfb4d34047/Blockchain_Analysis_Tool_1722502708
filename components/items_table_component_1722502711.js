...
Vue.component("items_table_component_1722502711", {
    ...
    <section id="items-table-component" class="py-8 bg-gradient-to-br from-pink-500 to-purple-600 backdrop-blur-lg bg-opacity-30 rounded-xl shadow-lg">
        ...
        <div id="costs-table-container" class="overflow-x-auto px-4">
            <table id="costs-table" class="table-auto w-full text-sm bg-white bg-opacity-10 backdrop-filter backdrop-blur-md rounded-lg">
                ...
                <tbody id="costs-table-body">
                    <tr class="group hover:bg-white hover:bg-opacity-20 transition-all duration-300" id="costs-row-1">
                        <th scope="row" class="text-left font-normal px-4 py-4 border-b border-purple-300 border-opacity-30" id="costs-cell-description-1">
                            <div class="font-semibold mb-1 text-pink-300" id="costs-link-1">
                        ...
                        <td class="font-semibold text-right px-4 py-4 border-b border-purple-300 border-opacity-30 text-white" id="costs-cell-cost-1">
                    ...
                    <tr class="group hover:bg-white hover:bg-opacity-20 transition-all duration-300" id="costs-row-2">
                        <th scope="row" class="text-left font-normal px-4 py-4 border-b border-purple-300 border-opacity-30" id="costs-cell-description-2">
                            <div class="font-semibold mb-1 text-pink-300" id="costs-link-2">
                                <a class="hover:text-white transition-colors duration-300" href="details.html">
                        ...
                        <td class="font-semibold text-right px-4 py-4 border-b border-purple-300 border-opacity-30 text-white" id="costs-cell-cost-2">
                    ...
                    <tr class="group hover:bg-white hover:bg-opacity-20 transition-all duration-300" id="costs-row-3">
                        <th scope="row" class="text-left font-normal px-4 py-4 border-b border-purple-300 border-opacity-30" id="costs-cell-description-3">
                            <div class="font-semibold mb-1 text-pink-300" id="costs-link-3">
                        ...
                        <td class="font-semibold text-right px-4 py-4 border-b border-purple-300 border-opacity-30 text-white" id="costs-cell-cost-3">
                    ...
                    <tr class="group hover:bg-white hover:bg-opacity-20 transition-all duration-300" id="costs-row-4">
                        <th scope="row" class="text-left font-normal px-4 py-4 border-b border-purple-300 border-opacity-30" id="costs-cell-description-4">
                            <div class="font-semibold mb-1 text-pink-300" id="costs-link-4">
                        ...
                        <td class="font-semibold text-right px-4 py-4 border-b border-purple-300 border-opacity-30 text-white" id="costs-cell-cost-4">
                    ...
                    <tr class="group hover:bg-white hover:bg-opacity-20 transition-all duration-300" id="costs-row-5">
                        <th scope="row" class="text-left font-normal px-4 py-4 border-b border-purple-300 border-opacity-30" id="costs-cell-description-5">
                            <div class="font-semibold mb-1 text-pink-300" id="costs-link-5">
                        ...
                        <td class="font-semibold text-right px-4 py-4 border-b border-purple-300 border-opacity-30 text-white" id="costs-cell-cost-5">
                    ...
                    <tr class="group hover:bg-white hover:bg-opacity-20 transition-all duration-300" id="costs-row-6">
                        <th scope="row" class="text-left font-normal px-4 py-4 border-b border-purple-300 border-opacity-30" id="costs-cell-description-6">
                            <div class="font-semibold mb-1 text-pink-300" id="costs-link-6">
                        ...
                        <td class="font-semibold text-right px-4 py-4 border-b border-purple-300 border-opacity-30 text-white" id="costs-cell-cost-6">
                            <a class="group-hover:opacity-0 transition-opacity" href="details.html" tabindex="-1">$99/month</a>
                            <span class="hidden group-hover:inline-block text-blue-300 transition-all duration-300">Details -></span>
                        </td>
                    </tr>
                ...
                <tfoot id="costs-table-footer">
                    <tr>
                        ...
                        <td id="total-cost" class="font-bold text-right text-lg px-4 py-4 text-pink-300">$494</td>
                    </tr>
                </tfoot>
            </table>
        </div>
