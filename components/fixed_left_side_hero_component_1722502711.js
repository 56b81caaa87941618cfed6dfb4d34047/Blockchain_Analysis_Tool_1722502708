            ...
            <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20 flex-1" id="quote-header">
                <div class="grow flex flex-col justify-center" id="quote-content">
                    <div class="space-y-3" id="quote-container">
                        ...
                        <h1 id="company-name" class="h1 font-orbiter font-bold text-white">Analyze Blockchains with Ease</h1>
                        <time id="quote-date" class="block font-caveat text-xl text-slate-400">Our cutting-edge app provides real-time insights and analytics for the latest blockchain information, empowering you to make informed decisions.</time>
                    </div>
                </div>
            </div>
        </div>
